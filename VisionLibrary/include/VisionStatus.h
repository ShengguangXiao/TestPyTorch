...
enum class VisionStatus
{
    ...
    HOUGH_FIND_CROSS_POINTS_FAIL        = 34,
    ...
    CALC_RESULT_FAIL_3D_SOLDER          = 105,
    CHECK_CRITERIA_FAIL_3D_SOLDER       = 106,
    HEIGHT_DIFF_OUT_OF_TOL              = 107,
    CALIB_3D_BASE_FAIL                  = 108,
    ...
    // Extra Unit found
    FOUND_EXTRA_UNITS                   = 230,

    // Find empty area
    FAIL_FIND_EMPTY_AREA                = 240,

    // Find mark
    FAIL_FIND_MARK                      = 260,

    // Generate device cad
    FAIL_GEN_DEVICE_CAD                 = 270,
};
